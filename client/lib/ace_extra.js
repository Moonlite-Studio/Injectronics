...
ace.settings = {
    ...
    sidebar_collapsed: function (c) {
        ...
        var d = $('#sidebar-collapse');
        
        if (c) {
            ace.addClass(e, "menu-min");
            $('#menu-button-toggle').removeClass('fa-angle-double-left').addClass('fa-angle-double-right');
            ace.settings.set("sidebar", "collapsed")
        } else {
            ace.removeClass(e, "menu-min");
            $('#menu-button-toggle').removeClass('fa-angle-double-right').addClass('fa-angle-double-left');
